...
class AlarmService : Service() {
    ...
    companion object {
        const val CHANNEL_ID = "geongik_departure_alarm_v2"   // 채널 설정은 만든 뒤 못 바꾸므로 새 ID 사용
        const val NOTI_ID = 4321
        const val ACTION_START = "kr.geongik.alarm.START"
        const val ACTION_STOP = "kr.geongik.alarm.STOP"
    ...
    private fun startAlerting() {
        ...
        try {
            ...
            wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "geongik:alarm")
